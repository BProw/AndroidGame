...
class Accelerometer : AppCompatActivity(), SensorEventListener {
    ...
    private val GMPLAY_MSGS =
                arrayOf("Ya dingus!", "Loser", "You lost!", "Poor, Reggie :(",
                        "Practice makes perfect?", "Not the worst...", "Seen better!",
                        "What waste of good burritos.", "Don't quit your day job.")

    private var randMsg = -1
    ...
    private lateinit var highScoreMenu : Intent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // highScoreMenu = Intent(this,HighScores::class.java)
    ...
    private fun timerField() {
        ...
        this.score = elapsedTime.toString()
    ...
    */
    ...
    private fun detectCollision() {
        ...
        randMsg = rand.nextInt(GMPLAY_MSGS.size)
        ...
        if(Rect.intersects(droidRect, missileRect) ||       // Droid hits missile or asteroid.
            ...
            outputMsg.text = GMPLAY_MSGS[randMsg]                  // Output error msg.
            outputMsg.visibility = View.VISIBLE
    ...
    private fun pauseAfterCollision() {
        val r = Runnable {

            highScoreMenu = Intent(applicationContext, HighScores::class.java)
            highScoreMenu.putExtra("score", getScore())
            //highScoreMenu.putExtra("out", outputMsg.text.toString())
            setResult(Activity.RESULT_OK, highScoreMenu)
            finish()

        }
        val h = Handler()
        h.postDelayed(r,1100) // (1100 milliseconds)
    }
